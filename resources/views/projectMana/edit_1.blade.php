        ...
        <div class="container-fluid px-[0.625rem]">
                ...
                <div class="grid grid-cols-1 mb-5">
                    <div class="flex items-center justify-between">
                        <h4 class="mb-sm-0 text-lg font-semibold grow text-gray-800 dark:text-gray-100"> 案件管理詳細
                        </h4>
                                ...
                                <div class="col-span-12 lg:col-span-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input
                                            ...
                                            id="project_type"  {{($project->progress_state > 1)? 'readonly' : '' }}>
                                        @error('project_type')
                                            <span class="invalid-feedback d-block" role="alert">
                                                <strong style="color:red;">{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea
                                            ...
                                            {{($project->progress_state > 5)? 'readonly' : '' }} >{{ $project->remittance_address }}</textarea>
                                    </div>
                                </div>
                                <div class="col-span-12 lg:col-span-6">
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input
                                            ...
                                            {{($project->progress_state > 5)? 'readonly' : '' }} >
                                        @error('amount')
                                            <span class="invalid-feedback d-block" role="alert">
                                                <strong style="color:red;">{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input
                                            ...
                                            {{($project->progress_state > 6)? 'readonly' : '' }}>
                                        @error('deposit')
                                            <span class="invalid-feedback d-block" role="alert">
                                                <strong style="color:red;">{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea
                                            ...
                                            >{{ $project->project_comment }}</textarea>
                                    </div>
                                </div>
