...
<div class="main-content overflow-auto">
    <div class="page-content dark:bg-zinc-700">
        ...
        <div class="container-fluid px-[0.625rem]">
            ...
            <input type="hidden" id="withdraw_store" value="{{ $store }}">

            <div class="grid grid-cols-1">
                <div class="card dark:bg-zinc-800 dark:border-zinc-600" style="min-height: calc(100vh - 218px);">
                    <div class="card-body pb-0">
                        <h6 class="mb-1 text-15 text-gray-700 dark:text-gray-100">出金情報追加</h6>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('withdrawMana.store') }}">
                            @csrf
                            <div class="grid grid-cols-12 gap-5">
                                <div class="col-span-12 lg:col-span-6">
                                    <div class="mb-4">
                                        <label for="withdrawal_date" class="block font-medium text-gray-700 dark:text-gray-100 mb-2">出金日 *</label>
                                        ...
                                        type="date" value="{{ Date('Y-m-d') }}" id="withdrawal_date" name="withdrawal_date">
                                ...
                                <div class="col-span-12 lg:col-span-6">
                                    <div class="mb-4">
                                        <label for="send_to" class="block font-medium text-gray-700 dark:text-gray-100 mb-2">受信者名 *</label>
                                        ...
                                        type="text" placeholder="山田　太郎" value="{{ old('send_to') }}" id="send_to" name="send_to">
                                        @error('send_to')
                                            <span class="invalid-feedback d-block" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-4">
                                        <label for="purpose" class="block font-medium text-gray-700 dark:text-gray-100 mb-2">用途 *</label>
                                        <input class="w-full rounded border-gray-100 placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100" 
                                        type="text" placeholder="" id="purpose" name="purpose">
                                        @error('purpose')
                                            <span class="invalid-feedback d-block" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
...
<div class="relative z-50 modal hidden" id="withdrawStoreModal" aria-labelledby="modal-title" role="dialog"
    aria-modal="true">
            ...
            <div
                ...
                <div class="p-5 text-center bg-white dark:bg-zinc-700">
                    ...
                    <div class="justify-center px-4 py-3 mt-5 border-gray-50 sm:flex sm:px-6">
                        <a href="{{ route('withdrawMana.create') }}" class="inline-flex justify-center w-full px-4 py-2 mt-3 text-base font-medium text-white border rounded-md shadow-sm btn dark:text-gray-100 hover:bg-gray-50/50 focus:outline-none focus:ring-2 focus:ring-gray-500/30 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm dark:bg-zinc-700 dark:border-zinc-600 dark:hover:bg-zinc-600 dark:focus:bg-zinc-600 dark:focus:ring-zinc-700 dark:focus:ring-gray-500/20 bg-green-500"
                            data-tw-dismiss="modal">追加</a>
                        <a href="{{ route('withdrawMana.index') }}" class="inline-flex justify-center w-full px-4 py-2 mt-3 text-base font-medium text-white bg-blue border rounded-md shadow-sm btn dark:text-gray-100 hover:bg-gray-50/50 focus:outline-none focus:ring-2 focus:ring-gray-500/30 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm dark:bg-zinc-700 dark:border-zinc-600 dark:hover:bg-zinc-600 dark:focus:bg-zinc-600 dark:focus:ring-zinc-700 dark:focus:ring-gray-500/20 bg-sky-500"
